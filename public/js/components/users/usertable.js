...
class UserTable extends HTMLElement {
    ...
    async render() {
        const url = `${apiURL}/user/getAll?select=id_user,name_user,last_name_user,dni_user,email_user,role_user,active_user`;
    ...
    <td data-label="Estado" class="enabled">${element.active_user ? `<span style="color: green; font-weight: bold;">Activo</span>` : `<span
            style="color: red; font-weight: bold;">Inactivo</span>`}</td>
    ...
    <div class="table-options">
        <div class="box">
            ...
            <label for="pages">Empleados por página</label>
        </div>
    ...
    <table id="users-table">
        <thead>
            <tr>
                ...
                <th><a class="sort" data-sort="email">E-mail</a></th>
                <th><a class="sort" data-sort="role">Tipo</a></th>
                <th><a class="sort" data-sort="enabled">Estado</a></th>
    ...
    <div class="table-options">
        ...
        this.querySelector("#table-items").innerHTML = `Total: ${userTable.items.length} empleados`;
    }
}
